...
KEYCLOAK_HOST="keycloak.internal"
REALM="flower-realm"
CALLBACK_URL="https://jupyterhub.internal/hub/oauth_callback"

echo "Ensure you replace CLIENT_SECRET in this script before running."
...
echo "Installation complete. Browse to https://jupyterhub.internal/hub/login"
```
